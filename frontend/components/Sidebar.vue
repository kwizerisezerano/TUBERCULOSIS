  ...
  <aside class="w-64 bg-white dark:bg-gray-900 text-gray-900 dark:text-white h-full flex flex-col border-r border-gray-200 dark:border-gray-800">
    ...
    <div class="p-6 border-b border-gray-200 dark:border-gray-800">
      <div class="flex items-center gap-3">
        <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-500 to-blue-600 flex items-center justify-center shadow-lg shadow-emerald-500/30">
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-800 space-y-2">
      ...
      <button
        @click="logout"
        class="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 transition-all duration-200"
      >
